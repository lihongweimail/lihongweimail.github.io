...
{if(!document.getElementById)return false;if(!document.getElementById('navcontainer'))return false;var navbar=document.getElementById('navcontainer');if(!navbar.getElementsByTagName('ul')[0])return false;var menu=navbar.getElementsByTagName('ul')[0];if(!menu.getElementsByTagName('li'))return false;var list_item=menu.getElementsByTagName('li')[0];list_item.style.border="none";}
